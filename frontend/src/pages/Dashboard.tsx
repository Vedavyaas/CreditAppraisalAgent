...
export const Dashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-4 sm:p-8 lg:p-12">
            {/* Sleek Enterprise global navigation bar */}
            <div className="w-full max-w-6xl flex justify-between items-center bg-white px-6 py-4 rounded-2xl border border-slate-200 shadow-sm mb-8">
                ...
                <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 active:bg-slate-200 border border-slate-200 rounded-xl shadow-sm transition-all text-slate-700"
                >
            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch pb-10">
                <MacWindow title="Credit Appraisal Ingestion" className="h-[500px]">
                    <UploadZone
