            ...
            {mlPred ? (
                <>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        {[
                            { label: 'Assurance Score', val: `${(mlPred.assuranceScore || 0).toFixed(1)}/100`, color: mlPred.assuranceScore >= 75 ? 'emerald' : mlPred.assuranceScore >= 40 ? 'amber' : 'red' },
                            ...
                            { label: 'Confidence', val: `${((mlPred.assuranceConfidence || 0) * 100).toFixed(0)}%`, color: 'indigo' },
                        ].map(s => (
